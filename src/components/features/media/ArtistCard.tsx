...
export function ArtistCard({
  ...
  const getArtistImageUrl = () => {
    ...
    const sortedImages = [...artist.images].sort(
  ...
  const { imageUrl, isLoading } = useImageCache(getArtistImageUrl(), 'artist', {
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 lg:gap-5">
        ...
        <div className="relative flex-shrink-0 self-center sm:self-auto">
          {isLoading ? (
            <div
              className="w-20 h-20 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full bg-gray-700 animate-pulse flex items-center justify-center"
              role="status"
              aria-label="loading"
            >
              <svg
            ...
            <img
              ...
              data-testid={`artist-image-${artist.id}`}
              onError={e => {
            ...
            <div className="mt-2 sm:mt-1">
              <div className="flex items-center justify-center sm:justify-start gap-1">
                ...
                {Array.from({ length: 5 }, (_, i) => {
                  ...
                  const isHalfFilled =
                    artist.popularity >= starValue - 10 &&
                    artist.popularity < starValue;
                    ...
                    <div key={i} className="relative">
                      ...
                      {(isFilled || isHalfFilled) && (
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          style={
                            isHalfFilled ? { clipPath: 'inset(0 50% 0 0)' } : {}
                          }
                        >
                          <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                        </svg>
      ...
      <div
        ...
        data-testid="artist-card-clickable-area"
      />
    </div>
  );
}
