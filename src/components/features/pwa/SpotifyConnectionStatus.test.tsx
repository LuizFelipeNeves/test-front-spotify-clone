...
describe('SpotifyConnectionStatus Component', () => {
  ...
  it('should display green indicator when online', () => {
    ...
    expect(indicator).toHaveClass('w-3', 'h-3', 'rounded-full', 'animate-pulse');
  });
  ...
  it('should apply custom className', () => {
    ...
    const { container } = render(<SpotifyConnectionStatus className={customClass} />);
  ...
  it('should handle multiple className values', () => {
    ...
    const { container } = render(<SpotifyConnectionStatus className={multipleClasses} />);
  ...
  it('should work with undefined className', () => {
    ...
    const { container } = render(<SpotifyConnectionStatus className={undefined} />);
