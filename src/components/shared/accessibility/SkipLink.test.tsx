...
describe('SkipLink', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with custom href', () => {
      render(
        <SkipLink href="#navigation" children="Pular para navegação" />
      );
    ...
    it('renders with custom children content', () => {
      render(
        <SkipLink href="#search" children="Ir para busca" />
      );
    ...
    it('renders with React element as children', () => {
      ...
      const link = screen.getByTestId('skip-link');
      expect(link).toContainHTML('<span>Pular para <strong>conteúdo</strong></span>');
    });
  });
  ...
  describe('Styling and Classes', () => {
    ...
    it('applies custom className', () => {
      render(
        <SkipLink {...defaultProps} className="custom-class" />
      );
    ...
    it('handles empty className', () => {
      render(
        <SkipLink {...defaultProps} className="" />
      );
    ...
    it('handles undefined className', () => {
      render(
        <SkipLink {...defaultProps} className={undefined} />
      );
    ...
    it('combines multiple custom classes', () => {
      render(
        <SkipLink {...defaultProps} className="custom-1 custom-2" />
      );
  ...
  describe('Accessibility', () => {
    ...
    it('is accessible by screen readers', () => {
      ...
      const link = screen.getByRole('link', { name: 'Pular para conteúdo principal' });
      expect(link).toBeInTheDocument();
    });
  ...
  describe('Edge Cases', () => {
    it('handles empty href', () => {
      render(
        <SkipLink href="" children="Empty href" />
      );
    ...
    it('handles special characters in href', () => {
      render(
        <SkipLink href="#content-with-special-chars_123" children="Special chars" />
      );
    ...
    it('handles long text content', () => {
      const longText = 'Este é um texto muito longo para o skip link que pode quebrar em múltiplas linhas';
      
      render(
        <SkipLink href="#content" children={longText} />
      );
    ...
    it('handles empty children', () => {
      render(
        <SkipLink href="#content" children="" />
      );
    ...
    it('handles null children gracefully', () => {
      render(
        <SkipLink href="#content" children={null} />
      );
