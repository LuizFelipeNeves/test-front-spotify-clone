...
export const LongContent: Story = {
  args: {
    ...
    description:
      'Você ainda não criou nenhuma playlist personalizada. As playlists são uma ótima maneira de organizar suas músicas favoritas por gênero, humor ou ocasião. Comece criando sua primeira playlist agora mesmo!',
    action: (
...
5. Teste a navegação para o botão de ação
  ...
  args: {
    ...
    description:
      'Este exemplo demonstra como o EmptyState é acessível para usuários de leitores de tela.',
    action: (
      <button
        onClick={fn()}
