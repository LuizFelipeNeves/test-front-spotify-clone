...
describe('ErrorState', () => {
  ...
  it('handles complex JSX message with links', () => {
    ...
    expect(screen.getByText('Erro de conexão com o Spotify.')).toBeInTheDocument();
  ...
  it('handles very long error messages', () => {
    const longMessage = 'Este é um erro muito longo que pode acontecer quando há problemas de conectividade ou quando o servidor está indisponível por um período prolongado de tempo e precisamos informar ao usuário sobre todos os detalhes do problema.';
