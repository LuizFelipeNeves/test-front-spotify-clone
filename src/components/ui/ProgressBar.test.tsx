...
describe('ProgressBar', () => {
  ...
  it('should handle maximum values', () => {
    render(
      <ProgressBar progress={180000} duration={180000} onSeek={vi.fn()} />
    );
  ...
  it('should render with different durations', () => {
    ...
    rerender(
      <ProgressBar progress={75000} duration={300000} onSeek={vi.fn()} />
    );
  ...
  it('should render with custom aria-label', () => {
    render(
      <ProgressBar {...defaultProps} aria-label="Custom progress label" />
    );
